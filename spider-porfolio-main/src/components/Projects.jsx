...
const MISSIONS = [
  {
    ...
    description: 'Built a responsive frontend clone of Instagram to enhance UI design and component structuring skills.',
  ...
  },
  {
    ...
    description: 'Developed an AI-based web platform that provides personalized career suggestions based on user input.',
    tech: ['React', 'JavaScript', 'HTML', 'CSS'],
    image: imgMan,
    link: '#',
  ...
  },
  {
    ...
    description: 'Created a dynamic movie browsing and booking interface with filtering features and state management.',
        ...
        <div ref={headerRef} className="mb-16 md:mb-24 flex flex-col md:flex-row md:items-end justify-between border-b border-white/10 pb-8">
          <div className="max-w-2xl">
            <h2 className="text-4xl md:text-5xl lg:text-[4.5rem] font-bold tracking-tighter text-white font-sans leading-none drop-shadow-lg mb-4">
              My <span className="font-serif italic font-light opacity-80 text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-white pr-2">Projects</span>
            </h2>
          </div>
          <p className="text-gray-400 font-light tracking-wide text-base md:text-lg max-w-sm mt-6 md:mt-0 leading-relaxed md:text-right">
            Showcase of web applications focusing on clean UI, logic, and problem-solving.
          </p>
        </div>

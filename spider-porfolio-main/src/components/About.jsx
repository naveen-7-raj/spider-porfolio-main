        ...
        <div ref={textContainerRef} className="flex flex-col justify-center space-y-10">
          ...
          <div className="overflow-hidden">
            <p className="stagger-reveal text-lg md:text-xl text-gray-400 font-light leading-relaxed max-w-xl">
              I am a Frontend Developer with a strong focus on clean UI, user experience, and logical functionality. I actively build AI-based and problem-solving web applications. My curiosity for emerging technologies and a passion for design let me craft digital solutions that bridge logic and creativity.
            </p>
          </div>
